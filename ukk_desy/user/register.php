    ...
    <div>
        <div>
            <div class="w-full px-[10rem] py-[3rem]">
                ...
                <form class="border border-black pb-5" action="../service/register_service.php" method="post">
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="mx-5">
                            ...
                            <input class="w-full pl-4 text-black border border-black" name="email" id="email" type="text" placeholder="Email" required/>
                        </div>
                        <div class="mx-5">
                        ...
                        <div class="mx-5">
                            ...
                            <input class="w-full pl-4 text-black border border-black" name="fullName" id="fullName" type="text" placeholder="Full Name" required/>
                        </div>
                        <div class="mx-5">
                            <label class="hidden" for="address">Address :</label>
                            <input class="w-full pl-4 text-black border border-black" name="address" id="address" type="text" placeholder="Address" required/>
                        </div>
                        <div class="mx-5 w-min">
                            <button class="bg-red-500 text-white p-2 rounded-md" type="submit" name="submit">Register</button>
                        </div>
                    </div>
                </form>
                <p>Already have account? <a class="underline" href="login.php">Login</a></p>
            </div>
        </div>
    </div>
</body>
